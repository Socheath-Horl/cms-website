...
| Project | Role | Tech |
|---------|------|------|
| `api/` | REST API + backend | Laravel 11, Sanctum, MySQL |
| `admin/` | Content management SPA | Vue 3, Pinia, PrimeVue, Vite :3001 |
| `public-site/` | Public-facing website | Nuxt 3, PrimeVue, Vite :3000 |

**Auth model**: Sanctum SPA (cookie-based) for admin, Sanctum token-based for public site.
...
| API auth | Laravel Sanctum (SPA cookies for admin, tokens for public) |
| Database | MySQL |
